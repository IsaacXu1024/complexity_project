#!/bin/bash
#SBATCH --time=00-24:00:00          # max walltime, hh:mm:ss
...
srun python ../../main.py \
    --method "barlow_twins" \
	--train_cfg "barlow_twins.cfg" \
	--aug_stack_cfg "simclr_cifar.cfg" \
    --filter_cfg "machine_animal.cfg" \
	--nodes $SLURM_JOB_NUM_NODES \
	--gpus $GPUS_PER_NODE \
	--name "barlow_twins_pre-train"
